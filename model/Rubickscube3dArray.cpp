...
public:
    ...
    bool operator==(const Rubickscube3dArray &r1) const {
        for (int i=0;i<6;i++) {
            for (int j=0;j<3;j++) {
                for (int k=0;k<3;k++) {
    ...
    Rubickscube3dArray &operator=(const Rubickscube3dArray &r1) {
        for (int i=0;i<6;i++) {
            for (int j=0;j<3;j++) {
                for (int k=0;k<3;k++) {
...
struct Hash3d {
    size_t operator()(const Rubickscube3dArray &r1) const {
        string str = "";
        for (int i=0;i<6;i++) {
            for (int j=0;j<3;j++) {
                for (int k=0;k<3;k++) {
